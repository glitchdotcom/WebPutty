...
*
* Download configuration: Use the nightly build (you don't really have a choice), don't include jQuery, but *do* include colour styles, css3 styles, and the "tips" plugin.
*
* Version: nightly
